moleküle = [
    ...
    {"name_de": "Neopentan", "name_en": "Neopentane", "smiles": "CC(C)(C)C", "difficulty": "medium"},
    ...
    {"name_de": "(E)-2-Buten", "name_en": "(E)-2-Butene", "smiles": "C/C=C/C", "difficulty": "medium"},
    {"name_de": "(Z)-2-Buten", "name_en": "(Z)-2-Butene", "smiles": "C/C=C\\C", "difficulty": "medium"},
    {"name_de": "(E)-1,2-Diphenylethen", "name_en": "(E)-1,2-Diphenylethene", "smiles": "C(=C/c1ccccc1)\\c1ccccc1", "difficulty": "hard"},

    # ─────────────────────────────────────────────────────────────
    # Alkine
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Ethin", "name_en": "Ethyne", "smiles": "C#C", "difficulty": "easy"},
    {"name_de": "Propin", "name_en": "Propyne", "smiles": "C#CC", "difficulty": "easy"},
    {"name_de": "But-1-in", "name_en": "But-1-yne", "smiles": "C#CCC", "difficulty": "easy"},
    {"name_de": "But-2-in", "name_en": "But-2-yne", "smiles": "CC#CC", "difficulty": "easy"},
    {"name_de": "Pent-1-in", "name_en": "Pent-1-yne", "smiles": "C#CCCC", "difficulty": "easy"},
    {"name_de": "Hex-1-in", "name_en": "Hex-1-yne", "smiles": "C#CCCCC", "difficulty": "easy"},
    ...
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Methanol", "name_en": "Methanol", "smiles": "CO", "difficulty": "easy"},
    {"name_de": "Ethanol", "name_en": "Ethanol", "smiles": "CCO", "difficulty": "easy"},
    {"name_de": "Propan-1-ol", "name_en": "Propan-1-ol", "smiles": "CCCO", "difficulty": "easy"},
    {"name_de": "Propan-2-ol", "name_en": "Propan-2-ol", "smiles": "CC(O)C", "difficulty": "easy"},
    {"name_de": "Butan-1-ol", "name_en": "Butan-1-ol", "smiles": "CCCCO", "difficulty": "easy"},
    {"name_de": "Butan-2-ol", "name_en": "Butan-2-ol", "smiles": "CCC(O)C", "difficulty": "easy"},
    ...
    {"name_de": "Pentan-1-ol", "name_en": "Pentan-1-ol", "smiles": "CCCCCO", "difficulty": "easy"},
    ...
    # Ether / Epoxide
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Dimethylether", "name_en": "Dimethyl ether", "smiles": "COC", "difficulty": "easy"},
    {"name_de": "Diethylether", "name_en": "Diethyl ether", "smiles": "CCOCC", "difficulty": "easy"},
    {"name_de": "Methyl-tert-butylether", "name_en": "Methyl tert-butyl ether", "smiles": "COC(C)(C)C", "difficulty": "medium"},
    {"name_de": "Anisol", "name_en": "Anisole", "smiles": "COc1ccccc1", "difficulty": "medium"},
    {"name_de": "Phenetol", "name_en": "Phenetole", "smiles": "CCOc1ccccc1", "difficulty": "medium"},
    {"name_de": "Tetrahydrofuran", "name_en": "Tetrahydrofuran", "smiles": "C1CCOC1", "difficulty": "medium"},
    ...
    {"name_de": "Propylenoxid", "name_en": "Propylene oxide", "smiles": "CC1CO1", "difficulty": "medium"},
    {"name_de": "Hydrochinondimethylether", "name_en": "Hydroquinone dimethyl ether", "smiles": "COc1ccc(OC)cc1", "difficulty": "hard"},
    {"name_de": "Butoxybenzol", "name_en": "Butoxybenzene", "smiles": "CCCCOc1ccccc1", "difficulty": "hard"},

    # ─────────────────────────────────────────────────────────────
    # Aldehyde
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Methanal", "name_en": "Methanal", "smiles": "C=O", "difficulty": "easy"},
    {"name_de": "Formaldehyd", "name_en": "Formaldehyde", "smiles": "C=O", "difficulty": "easy"},
    {"name_de": "Ethanal", "name_en": "Ethanal", "smiles": "CC=O", "difficulty": "easy"},
    {"name_de": "Propanal", "name_en": "Propanal", "smiles": "CCC=O", "difficulty": "easy"},
    {"name_de": "Butanal", "name_en": "Butanal", "smiles": "CCCC=O", "difficulty": "easy"},
    ...
    {"name_de": "Acrolein", "name_en": "Acrolein", "smiles": "C=CC=O", "difficulty": "medium"},
    {"name_de": "(E)-Crotonaldehyd", "name_en": "(E)-Crotonaldehyde", "smiles": "C/C=C/C=O", "difficulty": "medium"},
    {"name_de": "Benzaldehyd", "name_en": "Benzaldehyde", "smiles": "O=Cc1ccccc1", "difficulty": "medium"},
    ...
    {"name_de": "Furfural", "name_en": "Furfural", "smiles": "O=Cc1ccco1", "difficulty": "hard"},
    ...
    # Ketone
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Propanon (Aceton)", "name_en": "Propanone (acetone)", "smiles": "CC(=O)C", "difficulty": "easy"},
    {"name_de": "Butan-2-on", "name_en": "Butan-2-one", "smiles": "CCC(=O)C", "difficulty": "easy"},
    {"name_de": "Pentan-2-on", "name_en": "Pentan-2-one", "smiles": "CCCC(=O)C", "difficulty": "easy"},
    ...
    {"name_de": "Acetophenon", "name_en": "Acetophenone", "smiles": "CC(=O)c1ccccc1", "difficulty": "medium"},
    {"name_de": "Propiophenon", "name_en": "Propiophenone", "smiles": "CCC(=O)c1ccccc1", "difficulty": "hard"},
    {"name_de": "Benzophenon", "name_en": "Benzophenone", "smiles": "O=C(c1ccccc1)c1ccccc1", "difficulty": "hard"},
    {"name_de": "Benzil", "name_en": "Benzil", "smiles": "O=C(c1ccccc1)C(=O)c1ccccc1", "difficulty": "hard"},
    {"name_de": "p-Benzochinon", "name_en": "p-Benzoquinone", "smiles": "O=C1C=CC(=O)C=C1", "difficulty": "hard"},
    {"name_de": "Chalcon", "name_en": "Chalcone", "smiles": "O=C(/C=C/c1ccccc1)c1ccccc1", "difficulty": "hard"},
    ...
    # Carbonsäuren
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Ameisensäure", "name_en": "Formic acid", "smiles": "O=CO", "difficulty": "easy"},
    {"name_de": "Essigsäure", "name_en": "Acetic acid", "smiles": "CC(=O)O", "difficulty": "easy"},
    {"name_de": "Propionsäure", "name_en": "Propionic acid", "smiles": "CCC(=O)O", "difficulty": "easy"},
    {"name_de": "Buttersäure", "name_en": "Butyric acid", "smiles": "CCCC(=O)O", "difficulty": "easy"},
    {"name_de": "Isobuttersäure", "name_en": "Isobutyric acid", "smiles": "CC(C)C(=O)O", "difficulty": "medium"},
    ...
    {"name_de": "Salicylsäure", "name_en": "Salicylic acid", "smiles": "O=C(O)c1ccccc1O", "difficulty": "hard"},
    ...
    {"name_de": "Aspirin", "name_en": "Aspirin", "smiles": "CC(=O)Oc1ccccc1C(=O)O", "difficulty": "hard"},
    ...
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Methylacetat", "name_en": "Methyl acetate", "smiles": "CC(=O)OC", "difficulty": "easy"},
    {"name_de": "Ethylacetat", "name_en": "Ethyl acetate", "smiles": "CC(=O)OCC", "difficulty": "easy"},
    ...
    {"name_de": "Ethylbenzoat", "name_en": "Ethyl benzoate", "smiles": "CCOC(=O)c1ccccc1", "difficulty": "medium"},
    {"name_de": "Benzoesäureethylester", "name_en": "Ethyl benzoate", "smiles": "CCOC(=O)c1ccccc1", "difficulty": "medium"},
    ...
    # Amine
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Methylamin", "name_en": "Methylamine", "smiles": "CN", "difficulty": "easy"},
    {"name_de": "Ethylamin", "name_en": "Ethylamine", "smiles": "CCN", "difficulty": "easy"},
    {"name_de": "Propylamin", "name_en": "Propylamine", "smiles": "CCCN", "difficulty": "easy"},
    ...
    {"name_de": "Dimethylamin", "name_en": "Dimethylamine", "smiles": "CNC", "difficulty": "easy"},
    ...
    {"name_de": "Anilin", "name_en": "Aniline", "smiles": "Nc1ccccc1", "difficulty": "medium"},
    {"name_de": "p-Toluidin", "name_en": "p-Toluidine", "smiles": "Cc1ccc(N)cc1", "difficulty": "hard"},
    {"name_de": "p-Anisidin", "name_en": "p-Anisidine", "smiles": "COc1ccc(N)cc1", "difficulty": "hard"},
    ...
    # Nitrile / Nitro / Imin
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Acetonitril", "name_en": "Acetonitrile", "smiles": "CC#N", "difficulty": "easy"},
    {"name_de": "Propionitril", "name_en": "Propionitrile", "smiles": "CCC#N", "difficulty": "easy"},
    ...
    {"name_de": "Nitromethan", "name_en": "Nitromethane", "smiles": "C[N+](=O)[O-]", "difficulty": "easy"},
    {"name_de": "Nitroethan", "name_en": "Nitroethane", "smiles": "CC[N+](=O)[O-]", "difficulty": "easy"},
    ...
    {"name_de": "p-Nitrophenol", "name_en": "p-Nitrophenol", "smiles": "Oc1ccc([N+](=O)[O-])cc1", "difficulty": "hard"},
    ...
    # Halogenverbindungen
    # ─────────────────────────────────────────────────────────────
    {"name_de": "Chlormethan", "name_en": "Chloromethane", "smiles": "CCl", "difficulty": "easy"},
    {"name_de": "Dichlormethan", "name_en": "Dichloromethane", "smiles": "ClCCl", "difficulty": "easy"},
    {"name_de": "Chloroform", "name_en": "Chloroform", "smiles": "ClC(Cl)Cl", "difficulty": "easy"},
    {"name_de": "Tetrachlormethan", "name_en": "Carbon tetrachloride", "smiles": "ClC(Cl)(Cl)Cl", "difficulty": "medium"},
    {"name_de": "Bromethan", "name_en": "Bromoethane", "smiles": "CCBr", "difficulty": "easy"},
    {"name_de": "1-Chlorpropan", "name_en": "1-Chloropropane", "smiles": "CCCCl", "difficulty": "easy"},
    {"name_de": "2-Chlorpropan", "name_en": "2-Chloropropane", "smiles": "CC(Cl)C", "difficulty": "medium"},
    {"name_de": "1-Brombutan", "name_en": "1-Bromobutane", "smiles": "CCCCBr", "difficulty": "easy"},
    ...
    {"name_de": "p-Kresol", "name_en": "p-Cresol", "smiles": "Cc1ccc(O)cc1", "difficulty": "hard"},
    {"name_de": "Catechol", "name_en": "Catechol", "smiles": "Oc1ccccc1O", "difficulty": "hard"},
    {"name_de": "Resorcin", "name_en": "Resorcinol", "smiles": "Oc1cccc(O)c1", "difficulty": "hard"},
    {"name_de": "Hydrochinon", "name_en": "Hydroquinone", "smiles": "Oc1ccc(O)cc1", "difficulty": "hard"},
    ...
    {"name_de": "Thiophenol", "name_en": "Thiophenol", "smiles": "Sc1ccccc1", "difficulty": "hard"},
    {"name_de": "DMSO", "name_en": "DMSO", "smiles": "CS(=O)C", "difficulty": "medium"},
    {"name_de": "Dimethylsulfoxid", "name_en": "Dimethyl sulfoxide", "smiles": "CS(=O)C", "difficulty": "medium"},
